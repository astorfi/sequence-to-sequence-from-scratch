...
class Linear(nn.Module):
    ...
    def __init__(self):
        ...
        self.linear_connection_op = nn.Linear(num_directions * args.hidden_size_encoder, args.hidden_size_decoder)
        self.connection_possibility_status = num_directions * args.hidden_size_encoder == args.hidden_size_decoder
